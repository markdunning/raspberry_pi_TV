...
def create_new_channel_template(new_channel_name: str):
    ...
    try:
        ...
        # Update attributes that must change (name, content_root) or must use absolute paths (background_image_source).
        # Note: Attributes like 'start_time', 'end_time', and the new 'ident_xml' (which is relative) are automatically retained.
